...
const SalesEntry = () => {
  ...
  //       `https://arohanagroapi.microtechsolutions.co.in/php/get/gettblpage.php?Table=invoiceheader&PageNo=${pageNo}`
  ...
  const handleConfirmDelete = () => {
    ...
    fetch(`https://arohanagroapi.microtechsolutions.co.in/php/delete/deletetable.php?Table=invoiceheader&Id=${editId}`, requestOptions)
  ...
  const serchCustomers = () => {
    ...
    fetch(`https://arohanagroapi.microtechsolutions.co.in/php/get/searchaccount.php?TypeCode=C&Text=${text}`, requestOptions)
...
//                       <Button onClick={CreateCustomerMaster}
